const appearances = {
    ...
    outLinePrimary: 'bg-transparent border-primary border-2 text-primary font-bold',
    outLineSecondary: 'bg-transparent border-secondary border-2 text-secondary font-bold',
...
export { appearances, buttonSizes, iconButtonSizes, buttonPaddings, buttonRounded };
